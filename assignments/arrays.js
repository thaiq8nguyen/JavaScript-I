...
const findCarByID = function(inventory, id) {
    const index = inventory.findIndex(function(car) {
        return car.id === id;
    });
...
let carModels = inventory.sort(function(firstCar, secondCar){
    if(firstCar.car_model < secondCar.car_model) {
        return -1;
    }
...
console.log(`Old cars: ${oldCars.length} cars`); 
